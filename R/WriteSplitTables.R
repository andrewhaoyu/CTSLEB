...
#' @param ref_split_file Export path and prefix file name for ref data frame
#' Output file will be named "<refFile>_ref.txt". Default sum_ref.txt.
#' @param target_split_file Export path and prefix file name for target data frame
